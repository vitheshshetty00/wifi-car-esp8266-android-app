package cse.miniproject.wificar.screen
...
import cse.miniproject.wificar.connector.CarConnector
...
class ButtonControl : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arrow_up_right.setOnTouchListener { v: View, e: MotionEvent -> onTouchArrow(v, e) }
        arrow_up_left.setOnTouchListener { v: View, e: MotionEvent -> onTouchArrow(v, e) }
        ...
        arrow_down_left.setOnTouchListener { v: View, e: MotionEvent -> onTouchArrow(v, e) }
        arrow_down_right.setOnTouchListener { v: View, e: MotionEvent -> onTouchArrow(v, e) }
    ...
    private fun onTouchArrow(v: View, event: MotionEvent): Boolean {
        ...
        if (isTouchDown) {
            when (v.id) {
                ...
                R.id.arrow_up_right -> {
                    ...
                    arrow_up_right.setBackgroundResource(R.drawable.arrow_up_right_pressed)
                }
                R.id.arrow_up_left -> {
                    carConnector.moveForwardLeft()
                    arrow_up_left.setBackgroundResource(R.drawable.arrow_up_left_pressed)
                }
                R.id.arrow_down -> {
                    carConnector.moveBackward()
                    arrow_down.setBackgroundResource(R.drawable.arrow_down_pressed)
                }
                R.id.arrow_down_right -> {
                    carConnector.moveBackwardRight()
                    arrow_down_right.setBackgroundResource(R.drawable.arrow_down_right_pressed)
                }
                R.id.arrow_down_left -> {
                    carConnector.moveBackwardLeft()
                    arrow_down_left.setBackgroundResource(R.drawable.arrow_down_left_pressed)
                }
                R.id.arrow_right -> {
        ...
        if (isTouchUp) {
            ...
            when (v.id) {
                ...
                R.id.arrow_up_right -> arrow_up_right.setBackgroundResource(R.drawable.arrow_up_right)
                R.id.arrow_up_left -> arrow_up_left.setBackgroundResource(R.drawable.arrow_up_left)
                R.id.arrow_down -> arrow_down.setBackgroundResource(R.drawable.arrow_down)
                R.id.arrow_down_right -> arrow_down_right.setBackgroundResource(R.drawable.arrow_down_right)
                R.id.arrow_down_left -> arrow_down_left.setBackgroundResource(R.drawable.arrow_down_left)
