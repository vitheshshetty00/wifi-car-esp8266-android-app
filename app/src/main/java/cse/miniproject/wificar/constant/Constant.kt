package cse.miniproject.wificar.constant
...
object Constant {
    ...
    val MOVE_FORWARD_RIGHT_STORAGE = Storage("move_forward_right", "I")
    val MOVE_FORWARD_LEFT_STORAGE = Storage("move_forward_left", "G")
    val MOVE_BACKWARD_STORAGE = Storage("move_backward", "B")
    val MOVE_BACKWARD_RIGHT_STORAGE = Storage("move_backward_right", "J")
    val MOVE_BACKWARD_LEFT_STORAGE = Storage("move_backward_left", "H")
