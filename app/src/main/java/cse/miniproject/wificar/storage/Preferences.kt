package cse.miniproject.wificar.storage
...
class Preferences(ctx: Context) {
    ...
    fun getMoveForwardRightValue(): String = getSharedPreferencesValue(Constant.MOVE_FORWARD_RIGHT_STORAGE)
    fun getMoveForwardLeftValue(): String = getSharedPreferencesValue(Constant.MOVE_FORWARD_LEFT_STORAGE)
    fun getMoveBackwardValue(): String = getSharedPreferencesValue(Constant.MOVE_BACKWARD_STORAGE)
    fun getMoveBackwardRightValue(): String = getSharedPreferencesValue(Constant.MOVE_BACKWARD_RIGHT_STORAGE)
    fun getMoveBackwardLeftValue(): String = getSharedPreferencesValue(Constant.MOVE_BACKWARD_LEFT_STORAGE)
